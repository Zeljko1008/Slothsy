...
resetCarousel(): void {
  ...
  this.slideInterval = setInterval(() => {
    this.currentIndex = (this.currentIndex + 1) % this.carouselCategories.length;
  }, 5000);
}
  ...
  //     switch (gender) {
  //       case 'Men':
  //         return cat.gender === 0 && cat.ageGroup === 2;
  //       case 'Women':
  //         return cat.gender === 1 && cat.ageGroup === 2;
  //       case 'Kids':
  //         return cat.gender === 2 && cat.ageGroup === 1;
  //       default:
  //         return false;
  //     }
  //   });
