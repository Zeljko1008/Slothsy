        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductColorVariants_ColorOptions_ColorOptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductColorVariantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariantImages_ProductColorVariants_ProductColorVariantId",
                        column: x => x.ProductColorVariantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductColorVariantSlug = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ProductColorVariantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_ProductColorVariants_ProductColorVariantId",
                        column: x => x.ProductColorVariantId,
                        principalTable: "ProductColorVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductColorVariants_ColorOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantImages_ProductColorVariantId",
                table: "ProductVariantImages",
                column: "ProductColorVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ProductColorVariantId",
